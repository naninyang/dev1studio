...
const Icon = styled.i({
  background: `url(${images.logo.memorial.icon}) no-repeat 50% 50%/contain`,
  width: rem(150),
  height: rem(150),
});

const Typo = styled.i({
  background: `url(${images.logo.memorial.typo}) no-repeat 50% 50%/contain`,
  width: rem(180),
  height: rem(111),
});
          ...
          <div className={styles.item}>
            <div className={`${styles['item-front']} ${isActive ? styles.active : ''}`}>
              <header>
                ...
                <strong>memorial.newsbox</strong>
              </header>
              ...
              <footer>https://memorial.dev1stud.io</footer>
            </div>
            <div className={`${styles['item-back']} ${!isActive ? styles.active : ''}`}>
              <header>
                ...
                <div className={styles.secondary}>데브런닷스튜디오 기억뉴스상자</div>
              </header>
              <div className={styles.logo}>
                <div className={styles['logo-img']}>
                  <Typo />
              ...
              <footer>
                <div className={styles.primary}>https://memorial.dev1stud.io</div>
                <div className={styles.secondary}>메모리얼닷데브원스튜드닷아이오</div>
              </footer>
            </div>
          </div>
